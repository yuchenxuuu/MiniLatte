...
class SubjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update subject" do
    patch subject_url(@subject), params: { subject: { abbreviation: @subject.abbreviation, comment: @subject.comment, name: @subject.name, subject_id: @subject.subject_id, term: @subject.term,  segments: @subject.segments } }
